...
private:
    ...
    void train_mixed(const string &outputPath, TrainWindow &window);
...
void Train::train_mixed(const std::string &outputPath, TrainWindow &window) {
...
void Train::train_normal(std::string &outputPath, TrainWindow &window) {
    window.print_train();
    srand(343);
